...
public class DepartementRestController {
    ...
    private String sortField = "nomDep";
	...
	public List<Departement> getAllDepartements(Model model, @PathVariable("pageNumber") int currentPage, @Param("sortField") String sortField ,@Param("sortDirection") String sortDirection) {
	  ...
	  Departement one(@PathVariable String numDep) {
	    ...
	    return repository.findById(numDep)
	      .orElseThrow(() -> new EntitiesNotFoundException(numDep));
...
//        }
	  ...
	  Departement replaceDepartement(@Valid @NotNull @RequestBody Departement newDepartement) {
	    ...
	    return repository.findById(newDepartement.getNumDep())
	      .map(departement -> {
