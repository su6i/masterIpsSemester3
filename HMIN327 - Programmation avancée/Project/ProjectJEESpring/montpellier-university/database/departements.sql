...
`num_dep` VARCHAR(255) NULL,
`nom_dep` VARCHAR(255) NULL,
`chef_lieu` VARCHAR(255) NULL
);
...
('977','Saint-Barthélémy','Gustavia'),
('978','Saint-Martin','Marigot'),
('987','Polynésie française','Papeete'),
('989','Île de Clipperton','Clipperton'),
