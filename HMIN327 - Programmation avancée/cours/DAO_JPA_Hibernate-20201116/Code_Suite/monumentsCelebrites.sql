...
create table monument (geohash varchar(12) primary key, nom varchar(80), proprietaire varchar(10), typeM varchar(20), longitude float, latitude float, codeInsee varchar(6));
...
create table Celebrite(numCelebrite integer, nom varchar(16), prenom varchar(16), nationalite varchar(10),
epoque varchar(6));
alter table Celebrite add constraint Celebrite_pk primary key (numCelebrite);
...
foreign key (codeM) references Monument(geohash), foreign key (numCelebrite) references Celebrite(numCelebrite)) ;
